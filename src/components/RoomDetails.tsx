...
import Image from "../../public/deluxe.jpg"
...
const RoomDetails = () => {
    ...
    const maxLength = 200; // Adjust max length as needed
    ...
    useEffect(() => {
        ...
        if (!matchedRoom) {
            navigate("/404"); // Redirect if no matching room is found
            return;
        }
                                ...
                                {room.images.map((img: string, index: number) => (
                                    <img
                                        ...
                                        className={cn(
                                            ...
                                            index === currentImage ? "border-2 border-ultima-500 scale-110" : "opacity-70 hover:opacity-100"
                                        )}
